...
public class TestRideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getstates();
        getDealerslist();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(TestRideActivity.this);
        DealerlistRV.setLayoutManager(linearLayoutManager);
        DealerlistRV.setLayoutManager(new LinearLayoutManager(TestRideActivity.this, LinearLayoutManager.VERTICAL, false));
        ...
        SelectDt.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(TestRideActivity.this,
        ...
        SelectTm.setOnClickListener(v -> {
            ...
            TimePickerDialog timePickerDialog = new TimePickerDialog(TestRideActivity.this,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Global.urlBookTestDrive,
                    ...
                    public void onResponse(String sresponse) {
                        ...
                        try {
                            if (response.getBoolean("isSuccess")) {
                                Global.customtoast(TestRideActivity.this, getLayoutInflater(), response.getString("error"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    ...
                    Global.customtoast(TestRideActivity.this, getLayoutInflater(), "Internet connection unavailable");
                } else if (error instanceof ServerError) {
                    Global.customtoast(TestRideActivity.this, getLayoutInflater(), "Server Error");
                } else if (error instanceof NetworkError) {
                    Global.customtoast(TestRideActivity.this, getLayoutInflater(), "Network Error");
